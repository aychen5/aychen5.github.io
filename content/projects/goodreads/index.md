---
title: "Goodreads Wrapped: A Year in Reading, Reimagined" 
date: 2026-01-17
tags: ["data viz", "web app", "product", "storytelling"]
author: ["Annie Chen"]
description: "A shareable “year in reading” built from your Goodreads data."
cover:
    image: "goodreadswrapped_still.png"
    alt: "Goodreads slide"
    relative: true
showToc: false
...
![Img](goodreadswrapped_still3.png)
...
_NOTE: This project was built with heavy use of Cursor for AI-assisted coding. My focus was on product design, analytics definitions, and user experience, while using the tool to help implement the Next.js and TypeScript frontend and the in-browser Python analytics pipeline._ 
